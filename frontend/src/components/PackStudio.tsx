...
const s: Record<string, React.CSSProperties> = {
  ...
  modal: { width: "min(960px, 100%)", maxHeight: "90vh", overflow: "auto", background: "#1e1e2e", border: "1px solid #313244", borderRadius: 16, padding: 20 },
  header: { display: "flex", justifyContent: "space-between", gap: 16, marginBottom: 16 },
  kicker: { color: "#a6e3a1", fontSize: 11, fontWeight: 700, letterSpacing: "0.08em", textTransform: "uppercase" },
  title: { color: "#cdd6f4", fontSize: 20, fontWeight: 700, margin: "4px 0" },
  sub: { color: "#585b70", fontSize: 13, margin: 0, maxWidth: 520 },
  ...
  listPane: { flex: "1 1 220px", maxWidth: 280, borderRight: "1px solid #313244", paddingRight: 12 },
  listHeader: { display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 10 },
  listTitle: { color: "#a6adc8", fontSize: 12, fontWeight: 700 },
  tinyBtn: { padding: "4px 8px", fontSize: 11 },
  muted: { color: "#585b70", fontSize: 12, lineHeight: 1.4 },
  ...
  packRowActive: { background: "#31324455", borderColor: "#89b4fa44" },
  packName: { color: "#cdd6f4", fontSize: 13, fontWeight: 600 },
  packMeta: { color: "#585b70", fontSize: 11 },
  deleteLink: { color: "#f38ba8", fontSize: 11, marginTop: 4 },
  ...
  tplBtn: { background: "#181825", border: "1px solid #313244", color: "#a6adc8", borderRadius: 999, padding: "5px 10px", fontSize: 11, cursor: "pointer" },
  ...
  hint: { color: "#585b70", fontSize: 11, margin: 0, textAlign: "right" },
};
