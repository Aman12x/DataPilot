...
const s: Record<string, React.CSSProperties> = {
  ...
  headline:      { color: "var(--dp-ink)", fontSize: 19, fontWeight: 600, lineHeight: 1.45, margin: "0 0 22px", fontFamily: "var(--dp-display)" },
  ...
  heroMetric:    { fontSize: 30, fontWeight: 600, letterSpacing: "-0.5px", fontVariantNumeric: "tabular-nums" as const, fontFamily: "var(--dp-display)" },
